...
class UserController extends Controller
{
    ...
    {   
        ...
        return redirect()->route($this->controllerName)->with('zvn_notify', 'Cập nhật Level User thành công!');
    }
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route($this->controllerName)->with('zvn_notify', 'Xóa User thành công!');
    }
}